                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <?php
                                foreach ($addr as $key) {
                                    ?>
                                <span itemprop = "<?php echo $key  ?>"> <?php echo $current_post_address[0][$key] ?><br /></span>
                                <?php
                                }
                                ?>
                            </div>
...
//    foreach ($addr as $key){
//        echo "<span itemprop = \"".$key."\">".$current_post_address[0][$key];
//        echo "</span>\n<br />";
//    }
//     echo '<div id="map"></div></div>';
//    echo "</div>\n";
//    $phone_no=get_post_meta($post->ID,'_restaurant_contactno',true);
//    ?>
<!--    <div>
        <label class="labels">Contact Us:</label>
        <span itemprop="telephone">
